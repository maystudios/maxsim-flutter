...
4. `npm run test:coverage` — Coverage thresholds (from `jest.config.mjs`, never hardcode)
...
3. Compare against thresholds from `jest.config.mjs` `coverageThreshold.global`
